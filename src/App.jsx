...
export default function Example() {
  ...
  function handleDeleteEvent(id) {
    ...
    const CalendarHeader = () => (
      <header className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-6 px-6 sm:px-10 md:px-16 shadow-md rounded-lg mb-6">
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="text-center md:text-left mb-4 md:mb-0">
          ...
          <p className="text-sm md:text-lg font-light mt-2">
            Stay organized with your work and personal events
          </p>
        </div>
    
        {/* Action Button */}
        <div className="mt-4 md:mt-0">
          <button onClick={() => setIsAddingEvent(true)} className="bg-white text-blue-600 hover:bg-blue-500 hover:text-white font-semibold py-2 px-4 md:px-6 rounded-lg transition duration-300 shadow">
            + Add Event
          </button>
        </div>
      </div>
  ...
  return (
    <div className="pt-1 bg-custom-gradient">
